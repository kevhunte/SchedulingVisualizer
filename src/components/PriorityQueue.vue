<template>
<div>
  <h3 class="pb-2">Priority Queue</h3>

  <h6 class="pb-2">
    This algorithm schedules processes for execution by their priority value.
  </h6>
...
export default {
  ...
  created() {
    if (this.proc) {
      this.localCopy = this.proc.slice().sort((a, b) => a.priority > b.priority ? 1 : -1)
    }
  },
  mounted() {
